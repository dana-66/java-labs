...
public class EX2 {
    ...
    public static void print (int[][] m,int[][] weeklyHours){
        System.out.println("Employee                                                                            Weekly Hours");
        System.out.println("------------------------------------------------------------------------------------------------");
         for (int[] m1 : m) {
             printRaw(weeklyHours, m1[0]);
             System.out.printf("%9d\n", m1[1]);
         }
    }
    public static void printRaw(int[][]weeklyHours, int row){
        System.out.print("Employee " +row +" : ");
        for (int column = 0; column < weeklyHours[row].length; column++){
            System.out.printf("%4d",weeklyHours[row][column]);
        }
